...
const NAV = [
  ...
  },
  {
    ...
    label: '채팅',
    icon: (
      <path d="M3 5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2h-6l-5 4v-4H5a2 2 0 01-2-2V5z" />
    ),
  },
  {
    href: '/articles',
    label: '아티클',
    icon: (
      <path d="M4 19.5V5a2 2 0 012-2h12a2 2 0 012 2v14.5a.5.5 0 01-.8.4L12 15l-7.2 4.9a.5.5 0 01-.8-.4z" />
    ),
  },
  {
    href: '/account',
      ...
      {user && (
        <div className="border-t border-border px-4 py-3.5">
          <div className="flex items-center gap-2.5">
            <DmUserAvatar name={user.nickname} image={user.image} />
